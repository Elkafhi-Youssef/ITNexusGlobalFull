...
public class ProjectResource {
    ...
    @GetMapping("/{proId}")
    public ResponseEntity<ProjectDTO> getProject(@PathVariable(name = "proId") final Long proId) {
    ...
    @PutMapping("/{proId}")
    public ResponseEntity<Void> updateProject(@PathVariable(name = "proId") final Long proId,
    ...
    public ResponseEntity<Void> deleteProject(@PathVariable(name = "proId") final Long proId) {
