...
public class HobbieResource {
    ...
    @GetMapping("/{hobId}")
    public ResponseEntity<HobbieDTO> getHobbie(@PathVariable(name = "hobId") final Long hobId) {
    ...
    @PutMapping("/{hobId}")
    public ResponseEntity<Void> updateHobbie(@PathVariable(name = "hobId") final Long hobId,
    ...
    public ResponseEntity<Void> deleteHobbie(@PathVariable(name = "hobId") final Long hobId) {
