...
public class LanguageResource {
    ...
    public ResponseEntity<LanguageDTO> getLanguage(
            @PathVariable(name = "langId") final Long langId) {
    ...
    @PutMapping("/{langId}")
    public ResponseEntity<Void> updateLanguage(@PathVariable(name = "langId") final Long langId,
    ...
    public ResponseEntity<Void> deleteLanguage(@PathVariable(name = "langId") final Long langId) {
